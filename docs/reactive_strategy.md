...
The **Reactive Strategy** is the core decision-making logic used by the Sentinel Gelato Agent. It aims to maximize fee capture while minimizing rebalancing costs by dynamically adjusting range width based on market conditions.
...
The off-chain agent (Gelato Web3 Function) gathers three key data points before making a decision:
